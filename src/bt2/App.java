...
public class App {
    ...
    private JPanel mainPanel = new JPanel(); {
        ...
        addButton.addActionListener(e -> {
            ...
            try {
            	...
            	if(dateField.getText().trim().equals("")) {JOptionPane.showMessageDialog(frame, "Vui long nhap nam sang tac!");}
            	else{JOptionPane.showMessageDialog(frame, "Nam sang tac phai la so nguyen!");}
                return;
            }
    ...
    public App() {
        ...
        frame.add(paintInforPanel, BorderLayout.CENTER);
